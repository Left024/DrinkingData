...
if timeD==1 and timeH==0 and timeM<=30:
    ...
    # 设置字体
    font = {'family': 'serif', 'color': '#adbac7'}
    ...
    # 设置坐标轴颜色
    ax = plt.gca()  # 获取当前坐标轴
    ax.spines['bottom'].set_color('#adbac7')  # 设置底边框颜色
    ax.spines['left'].set_color('#adbac7')  # 设置左边框颜色
    ax.tick_params(axis='both', colors='#adbac7')  # 设置刻度颜色
    fig.tight_layout()
